!(function (e, t) {
  "object" == typeof exports && "object" == typeof module
    ...
    ? define("babylonjs-post-process", ["babylonjs"], t)
    : "object" == typeof exports
    ? (exports["babylonjs-post-process"] = t(require("babylonjs")))
    : (e.POSTPROCESSES = t(e.BABYLON));
  ...
  (() => {
    ...
    o.r(n),
      o.d(n, {
        AsciiArtFontTexture: () => g,
        AsciiArtPostProcess: () => u,
        DigitalRainFontTexture: () => m,
        DigitalRainPostProcess: () => p,
        EdgeDetectionPostProcess: () => S,
      });
    var a = {};
    o.r(a),
      o.d(a, {
    ...
    function s(e, t, r, o) {
      ...
      if ("object" == typeof Reflect && "function" == typeof Reflect.decorate) a = Reflect.decorate(e, t, r, o);
        ...
        for (var l = e.length - 1; l >= 0; l--) (i = e[l]) && (a = (n < 3 ? i(a) : n > 3 ? i(t, r, a) : i(t, r)) || a);
      return n > 3 && a && Object.defineProperty(t, r, a), a;
    }
    Object.create, Object.create, "function" == typeof SuppressedError && SuppressedError;
    var c = o(597),
      d = "asciiartPixelShader";
    c.ShaderStore.ShadersStore[d] ||
      (c.ShaderStore.ShadersStore[d] =
    ...
    var g = (function (e) {
        function t(t, r, o, i) {
          ...
          (n.name = t),
            n._text,
            n._font,
            (n.wrapU = c.Texture.CLAMP_ADDRESSMODE),
            (n.wrapV = c.Texture.CLAMP_ADDRESSMODE);
          var a = n._getFontHeight(r),
            l = n._getFontWidth(r);
          n._charSize = Math.max(a.height, l);
          var f = Math.ceil(n._charSize * o.length),
            s = n._charSize;
          ...
          (u.textBaseline = "top"), (u.font = r), (u.fillStyle = "white"), (u.imageSmoothingEnabled = !1);
          for (var h = 0; h < o.length; h++) u.fillText(o[h], h * n._charSize, -a.offset);
          return i.getEngine().updateDynamicTexture(n._texture, g, !1, !0), n;
        }
        return (
          f(t, e),
          Object.defineProperty(t.prototype, "charSize", {
            get: function () {
          ...
          (t.prototype._getFontWidth = function (e) {
            var t = document.createElement("canvas").getContext("2d");
            return (t.fillStyle = "white"), (t.font = e), t.measureText("W").width;
          }),
          (t.prototype._getFontHeight = function (e) {
            ...
            r.fillRect(0, 0, t.width, t.height),
              ...
              (r.font = e),
              r.fillText("jH|", 0, 0);
            for (var o = r.getImageData(0, 0, t.width, t.height).data, i = -1, n = -1, a = 0; a < t.height; a++)
              for (var l = 0; l < t.width; l++) {
                if (0 !== o[4 * (a * t.width + l)]) {
                  -1 === i && (i = a);
                  break;
                }
                if (l === t.width - 1 && -1 !== i) {
          ...
          (t.prototype.clone = function () {
            return new t(this.name, this._font, this._text, this.getScene());
          }),
          (t.Parse = function (e, r) {
            return c.SerializationHelper.Parse(
              function () {
                return new t(e.name, e.font, e.text, r);
              },
              e,
              r,
              null
          ...
          s([(0, c.serialize)("font")], t.prototype, "_font", void 0),
          s([(0, c.serialize)("text")], t.prototype, "_text", void 0),
          t
        );
      })(c.BaseTexture),
      u = (function (e) {
        function t(t, r, o) {
          var i =
            e.call(
              ...
              1,
              r,
              c.Texture.TRILINEAR_SAMPLINGMODE,
              void 0,
              !0
            ) || this;
          ...
          o &&
            ("string" == typeof o
              ...
              : ((n = o.font || n),
                (a = o.characterSet || a),
                (i.mixToTile = o.mixToTile || i.mixToTile),
                (i.mixToNormal = o.mixToNormal || i.mixToNormal)));
          var l = (null == r ? void 0 : r.getScene()) || i._scene;
          i._asciiArtFontTexture = new g(t, n, a, l);
          var f = i._asciiArtFontTexture.getSize();
          return (
            (i.onApply = function (e) {
              e.setTexture("asciiArtFont", i._asciiArtFontTexture),
                e.setFloat4("asciiArtFontInfos", i._asciiArtFontTexture.charSize, a.length, f.width, f.height),
                e.setFloat4("asciiArtOptions", i.width, i.height, i.mixToNormal, i.mixToTile);
            }),
            i
          );
        }
    ...
    var m = (function (e) {
        function t(t, r, o, i) {
          ...
          n._charSize = Math.max(a.height, l);
          var f = n._charSize,
            s = Math.ceil(n._charSize * o.length);
          n._texture = i.getEngine().createDynamicTexture(f, s, !1, c.Texture.NEAREST_SAMPLINGMODE);
          var d = n.getSize(),
            g = document.createElement("canvas");
          (g.width = d.width), (g.height = d.height);
          var u = g.getContext("2d");
          (u.textBaseline = "top"), (u.font = r), (u.fillStyle = "white"), (u.imageSmoothingEnabled = !1);
          for (var h = 0; h < o.length; h++) u.fillText(o[h], 0, h * n._charSize - a.offset);
          return i.getEngine().updateDynamicTexture(n._texture, g, !1, !0), n;
        }
        return (
          f(t, e),
      ...
      p = (function (e) {
        function t(t, r, o) {
          ...
          (i.mixToTile = 0), (i.mixToNormal = 0), (i.speed = 0.003);
          ...
          o &&
            ("string" == typeof o
              ...
              : ((n = o.font || n),
                (i.mixToTile = o.mixToTile || i.mixToTile),
                (i.mixToNormal = o.mixToNormal || i.mixToNormal)));
          var a = (null == r ? void 0 : r.getScene()) || null;
          i._digitalRainFontTexture = new m(
            t,
            n,
            "古池や蛙飛び込む水の音ふるいけやかわずとびこむみずのおと初しぐれ猿も小蓑をほしげ也はつしぐれさるもこみのをほしげなり江戸の雨何石呑んだ時鳥えどのあめなんごくのんだほととぎす",
            a
          );
          var l = i._digitalRainFontTexture.getSize(),
            f = 0,
            s = 0,
            d = c.Matrix.FromValues(
              Math.random(),
              Math.random(),
              Math.random(),
              Math.random(),
          ...
          return (
            (i.onApply = function (e) {
              e.setTexture("digitalRainFont", i._digitalRainFontTexture),
                e.setFloat4("digitalRainFontInfos", i._digitalRainFontTexture.charSize, 86, l.width, l.height),
                e.setFloat4("digitalRainOptions", i.width, i.height, i.mixToNormal, i.mixToTile),
                e.setMatrix("matrixSpeed", d),
                (f += i.speed),
                (s = f),
                e.setFloat("cosTimeZeroOne", s);
            }),
            i
          );
        }
    ...
    var S = (function (e) {
      function t(t, r, o, i, n, a, l) {
        ...
        if (
          ((f.edgeColor = new c.Color3(0, 0, 0)),
          (f.edgeIntensity = 0.2),
          (f.edgeWidth = 0.2),
          (f.renderMode = 0),
          (f._geometryBufferRenderer = r.enableGeometryBufferRenderer()),
          f._geometryBufferRenderer)
        ) {
          var s = new c.RenderTargetTexture("h1", { width: f.width, height: f.height }, r, {
            samplingMode: c.Constants.TEXTURE_NEAREST_NEAREST,
            generateMipMaps: !1,
            generateDepthBuffer: !1,
            type: c.Constants.TEXTURETYPE_HALF_FLOAT,
          });
          f.onApply = function (e) {
            e.setFloat("width", f.width),
              e.setFloat("height", f.height),
              e.setFloat("edgeIntensity", f.edgeIntensity),
              e.setFloat("edgeWidth", f.edgeWidth),
              e.setColor3("edgeColor", f.edgeColor);
            var t = f._geometryBufferRenderer.getGBuffer().textures[1],
              r = f._geometryBufferRenderer.getGBuffer().textures[0];
            switch ((e.setTexture("normalSampler", t), e.setTexture("depthSampler", r), f.renderMode)) {
              case 0:
                break;
              case 1:
                e.setTexture("textureSampler", f._geometryBufferRenderer.getGBuffer().textures[1]),
                  e.setFloat("edgeWidth", 0);
                break;
              case 2:
                e.setTexture("textureSampler", f._geometryBufferRenderer.getGBuffer().textures[0]),
                  e.setFloat("edgeWidth", 0);
                break;
              case 3:
                e.setTexture("textureSampler", s);
            }
            e.setInt("renderMode", f.renderMode);
          };
        } else c.Logger.Error("Geometry Buffer Renderer support is required for this post-process.");
        return f;
      }
      return (
        f(t, e),
        ...
        Object.defineProperty(t, "IsSupported", {
          get: function () {
            var e = c.EngineStore.LastCreatedEngine;
            return !!e && e.getCaps().drawBuffersExtension;
          },
          enumerable: !1,
          configurable: !0,
        }),
        (t._Parse = function (e, r, o, i) {
          return c.SerializationHelper.Parse(
            function () {
              return new t(e.name, o, e.options, r, e.renderTargetSamplingMode, e.textureType, e.reusable);
            },
            e,
            o,
            i
        ...
        s([(0, c.serialize)()], t.prototype, "edgeColor", void 0),
        s([(0, c.serialize)()], t.prototype, "edgeIntensity", void 0),
        s([(0, c.serialize)()], t.prototype, "edgeWidth", void 0),
        s([(0, c.serialize)()], t.prototype, "renderMode", void 0),
        t
      );
    })(c.PostProcess);
    (0, c.RegisterClass)("BABYLON.EdgeDetectionPostProcess", S);
    var v = void 0 !== o.g ? o.g : "undefined" != typeof window ? window : void 0;
    if (void 0 !== v) for (var y in n) v.BABYLON[y] = n[y];
    const T = a;
    return i.default;
  })()
);
